    ...
    <div class="row">
      ...
      <div class="col-sm-6 col-lg-3">
        <div class="card card-inverse card-danger">
          ...
          <div class="card-footer px-3 py-2">
            <router-link :to="'/dashboard/projects/vallejo-2017/sentiment'" class="font-weight-bold font-xs btn-block text-muted"><i class="fa fa-angle-right float-right font-lg"></i> View More</router-link>
          </div>
        </div>
      </div><!--/.col-->
    </div><!--/.row-->
